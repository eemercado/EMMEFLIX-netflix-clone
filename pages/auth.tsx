...
const Auth = () => {
    ...
    const register = useCallback(async () => { /* edge case: user enters blank and mongo retrieves blank user pass but doesn't allow login? */
        try {
                ...
                <div className="flex justify-center">
                    <div className="bg-black bg-opacity-70 px-14 py-16 self-center mt-2 lg:w-2/5 lg:max-w-md rounded-md w-full">
                        ...
                        <p className="text-neutral-500 mt-12">
                            {variant === 'login' ? 'First time using Emmeflix? ' : 'Already have an account?'}
